...
function App() {
  ...
  <div className = {`flex  h-screen w-full overflow-hidden ${theme? "bg-[#0a0a0a]" : "bg-slate-50"}`}>
    <aside className={` hidden md:flex flex-col shrink-0 w-64 lg:w-72 h-full border-r border-gray-100 transition-all duration-300`}>
      <ul className=' '>
        <li>
          About
        </li>
    ...
    <main className='flex-1 flex flex-col  w-full h-full overflow-hidden relative'>
      <div className='flex-1  overflow-y-auto custom-scrollbar '>
        <div  className='w-full  max-w-2xl px-12 lg:px-24 h-102 flex flex-col gap-8 justify-end'>
         <div>
          <h1 className='md:text-2xl text-xl font-semibold md:font-bold'>Hi, I'm Aniket</h1>
          <h3 className='md:text-xl text-lg text-gray-500 '>Final-year Computer Engineering student</h3>
          <p className='text-lg my-10'>
             I enjoy building clean, responsive websites and learning modern technologies to create meaningful digital experiences.
          </p>
      ...
      <div  className='w-full max-w-2xl px-12 lg:px-24 h-80 flex flex-col gap-8 mt-10 border-t  border-gray-200  '>
         <div className='mt-10'>
          <h1 className='md:text-xl text-xl font-semibold md:font-bold'>Personal Projects</h1>
